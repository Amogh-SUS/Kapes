...
<body>
    ...
    <div class="header">
        <div class="title">
            <h1>TSHIRTS</h1><center><hr></center><br><br>
            <p>Please contact us for customization</p>
        </div>
        <div class="product-center">
            <div class="product-item">
                <div class="overlay">
                        <img src="products/tshirt1.jpg" alt="" class="product-thumb">
                    </div>
                <div class="product-info">
                    <span>Tshirt</span>
                    <h4>Rs 499</h4><br>
                    <button class="order" onclick="order('T001')">Order</button>
                </div>
            </div>
            <div class="product-item">
                <div class="overlay">
                        <img src="products/tshirt2.jpg" alt="" class="product-thumb">
                    </div>
                <div class="product-info">
                    <span>Tshirt</span>
                    <h4>Rs 549</h4><br>
                    <button class="order" onclick="order('T002')">Order</button>
                </div>
            </div>
        </div>
        <div class="product-item">
            <div class="overlay">
                    <img src="products/tshirt3.jpg" alt="" class="product-thumb">
                </div>
            <div class="product-info">
                <span>Tshirt</span>
                <h4>Rs 599</h4><br>
                <button class="order" onclick="order('T003')">Order</button>
            </div>
        </div>
    </div>
    <br><br><br>
